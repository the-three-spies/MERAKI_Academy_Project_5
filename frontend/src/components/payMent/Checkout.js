...
const getStripe = () => {
  if (!stripePromise) {
    stripePromise = loadStripe('pk_test_51M4mbsAfQqkZDeROXg9a4gsforPF45pYdoJZvVraUnSXUXFj3bKEFwd7qnv9605FDlMlsjz7auZ3W7LjIFM1KR8800RwcUvlRm');
  }
...
const Checkout = () => {
  ...
  return (
    <div className="checkout">
      ...
      <p className="checkout-title">Fitrat Insan
A House Of Givivig & Power Generosity</p>
